...
if luthfiganteng_banget in ['1']:
	os.system("xdg-open https://wa.me/+6282267229931?text=ASSALAMUALAIKUM BANG SAYA MAU BELI SC 1DAY 10K")
elif luthfiganteng_banget in ['2']:
	os.system("xdg-open https://wa.me/+6282267229931?text=ASSALAMUALAIKUM BANG SAYA MAU BELI SC 2DAY 20K")
elif luthfiganteng_banget in ['3']:
	os.system("xdg-open https://wa.me/+6282267229931?text=ASSALAMUALAIKUM BANG SAYA MAU BELI SC 3DAY 30K")
elif luthfiganteng_banget in ['4']:
	os.system("xdg-open https://wa.me/+6282267229931?text=ASSALAMUALAIKUM BANG SAYA MAU BELI SC 1BULAN 100K")
elif luthfiganteng_banget in ['5']:
	os.system("xdg-open https://wa.me/+6282267229931?text=ASSALAMUALAIKUM BANG SAYA MAU BELI SC OPEN SOURCE 230K")
elif luthfiganteng_banget in ['0']:
	exit()
loading()
os.system('clear')
banner()	
